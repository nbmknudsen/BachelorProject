...
public class ControlFeedbackInstrumentedTest {
    ...
    PlayMusicOld playMusicFast;
    PlayMusicOld playMusicMedium;
    PlayMusicOld playMusicSlow;
    ...
    public void setUp() {
        ...
        playMusicFast = new PlayMusicOld();
        playMusicMedium = new PlayMusicOld();
        playMusicSlow = new PlayMusicOld();
